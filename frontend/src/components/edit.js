...
export default function Edit() {
 ...
 useEffect(() => {
   async function fetchData() {
     ...
     const response = await fetch(`http://18.183.115.12:3001/CustomerRoutes/${params.id.toString()}`);
 ...
 async function onSubmit(e) {
   ...
   await fetch(`http://18.183.115.12:3001/update/${params.id}`, {
     method: "POST",
     ...
     <form onSubmit={onSubmit}>
       ...
       <div className="form-group">   
         <div className="form-check form-check-inline">
           ...
           />
           <label htmlFor="levelJunior" className="form-check-label">Student</label>
            </div>
         <div className="form-check form-check-inline">
           <input
             className="form-check-input"
